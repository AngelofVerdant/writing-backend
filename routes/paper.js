...
const {
  create, getAllPaginate, updateById, getById, deleteById, getAll, getPaperTypes,
...
router.route("/papertypes/:paperId").get(getPaperTypes);
router.route("/:paperId").get(getById);
router.route("/:paperId").patch(onlyAdmin, updateById);
router.route("/:paperId").delete(onlyAdmin, deleteById);
